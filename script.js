  ...
  const spotMarkup = spots
    .map((spot) => {
      ...
      <g class='map-spot' data-spot-id='${spot.id}'>
        ...
        <text x='${p.px}' y='${p.py + 28}' text-anchor='middle' font-size='40' fill='#111827' stroke='white' stroke-width='6' paint-order='stroke'>${spot.displayName}</text>
        <text x='${p.px}' y='${p.py + 28}' text-anchor='middle' font-size='40' fill='#111827'>${spot.displayName}</text>
